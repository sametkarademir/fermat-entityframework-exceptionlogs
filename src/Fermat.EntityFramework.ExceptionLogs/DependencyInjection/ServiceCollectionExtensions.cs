...
using Fermat.EntityFramework.ExceptionLogs.Application.Services;
using Fermat.EntityFramework.ExceptionLogs.DependencyInjection.Logging;
...
using Fermat.EntityFramework.ExceptionLogs.Domain.Options;
using Fermat.EntityFramework.ExceptionLogs.Infrastructure.Repositories;
using Fermat.EntityFramework.ExceptionLogs.Presentation.Controllers;
using Fermat.EntityFramework.ExceptionLogs.Presentation.Filters;
...
{
    public static IServiceCollection AddFermatExceptionLogServices<TContext>(this WebApplicationBuilder builder, Action<ExceptionLogOptions> configureOptions) where TContext : DbContext
    {
